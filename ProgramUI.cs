...
namespace SD76_ConsoleGame
{
    public class ProgramUI
    {
        ...
        public void RunMenu()
        {
            ...
            Console.WriteLine("Think you have what it takes to win?");
        ...
        static void RunGame()
        {
            ...
            do
            {
                ...
                do
                {
                    Console.WriteLine("Player " + (playerPiece) + ",You're Up!", player);
                    try
                    {
                    ...
                    {
                        Console.WriteLine("Enter the number of the box you'd like to place your piece:");
                    ...
                    {
                        Console.WriteLine("No can do buddy, Try again");
                        inputCorrect = false;
                    }
                } while (!inputCorrect);
            } while (true);
